...
import deepwatermap
import glob
from custom_metrics import running_precision, running_recall, running_f1, focal_loss, adaptive_maxpool_loss, keras_lovasz_hinge

class TFModelTrainer:
    def __init__(self, checkpoint_dir='./checkpoints_scratch/'):
